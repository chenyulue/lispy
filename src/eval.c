...
// {
//     if (STR_EQ("list", func)) return builtin_list(e, a);
//     if (STR_EQ("head", func)) return builtin_head(e, a);
//     if (STR_EQ("tail", func)) return builtin_tail(e, a);
//     if (STR_EQ("join", func)) return builtin_join(e, a);
//     if (STR_EQ("eval", func)) return builtin_eval(e, a);
//     if (STR_CONTAIN("+-*/", func)) return builtin_op(e, a, func);
//     lval_del(a);
...
void lval_print(lval *v)
{
    ...
    case LVAL_FUN:
        printf("<function> at 0X%p", (void*)v->fun);
        break;
    }
}
